...
if {[file isfile decompressor_kernel.autotvin.dat]} {
	file delete -force decompressor_kernel.autotvin.dat
}

if {[file isfile decompressor_kernel.autotvout.dat]} {
	file delete -force decompressor_kernel.autotvout.dat
}
