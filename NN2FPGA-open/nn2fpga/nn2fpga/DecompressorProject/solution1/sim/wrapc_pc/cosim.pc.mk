...
$(ObjDir)/decompress_tb.cpp_pre.cpp.tb.o : decompress_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling decompress_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/decompressor_kernel.cc_pre.cc.tb.o : decompressor_kernel.cc_pre.cc.tb.cc $(ObjDir)/.dir
	$(Echo) "   Compiling decompressor_kernel.cc_pre.cc.tb.cc" $(AVE_DIR_DLOG)
