...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "decompressor_kernel.autotvin.dat"
	set constFileTvOut       "decompressor_kernel.autotvout.dat"
	set constFileHdlTvIn     "decompressor_kernel.autohdltvin.dat"
	set constFileHdlTvOut    "decompressor_kernel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
