set moduleName huffmanDecoderLL_2_0_Pipeline_consumeLeftOverData
set isTopModule 0
...
set C_modelName {huffmanDecoderLL<2, 0>_Pipeline_consumeLeftOverData}
set C_modelType { void 0 }
set C_modelArgList {
	{ done_19 int 1 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "done_19", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ huffman_eos_stream_dout sc_in sc_lv 1 signal 2 } 
	{ huffman_eos_stream_empty_n sc_in sc_logic 1 signal 2 } 
	{ huffman_eos_stream_read sc_out sc_logic 1 signal 2 } 
	{ huffman_input_stream_dout sc_in sc_lv 16 signal 1 } 
	{ huffman_input_stream_empty_n sc_in sc_logic 1 signal 1 } 
	{ huffman_input_stream_read sc_out sc_logic 1 signal 1 } 
	{ done_19 sc_in sc_lv 1 signal 0 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "done_19", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "done_19", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	done_19 { ap_none {  { done_19 in_data 0 1 } } }
