...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { lz77_output_stream_dout { I 16 vector } lz77_output_stream_empty_n { I 1 bit } lz77_output_stream_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 334 \
    name decompressed_count_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_decompressed_count_out \
    op interface \
    ports { decompressed_count_out { O 32 vector } decompressed_count_out_ap_vld { O 1 bit } } \
} "
}
