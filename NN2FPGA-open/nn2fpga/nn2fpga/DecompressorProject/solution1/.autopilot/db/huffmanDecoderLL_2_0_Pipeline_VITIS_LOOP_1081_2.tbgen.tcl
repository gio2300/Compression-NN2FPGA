set moduleName huffmanDecoderLL_2_0_Pipeline_VITIS_LOOP_1081_2
set isTopModule 0
...
set C_modelName {huffmanDecoderLL<2, 0>_Pipeline_VITIS_LOOP_1081_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln1069 int 5 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln1069", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln1069 sc_in sc_lv 5 signal 0 } 
	{ dynamic_lens_address0 sc_out sc_lv 9 signal 1 } 
	{ dynamic_lens_ce0 sc_out sc_logic 1 signal 1 } 
	{ dynamic_lens_we0 sc_out sc_logic 1 signal 1 } 
	{ dynamic_lens_d0 sc_out sc_lv 5 signal 1 } 
	{ order_address0 sc_out sc_lv 5 signal 2 } 
	{ order_ce0 sc_out sc_logic 1 signal 2 } 
	{ order_q0 sc_in sc_lv 5 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln1069", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "zext_ln1069", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln1069 { ap_none {  { zext_ln1069 in_data 0 5 } } }
