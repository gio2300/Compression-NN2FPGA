...
entity decompressor_kernel_fifo_w16_d2_S is 
    generic (
...
architecture rtl of decompressor_kernel_fifo_w16_d2_S is

    component decompressor_kernel_fifo_w16_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 16;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_decompressor_kernel_fifo_w16_d2_S_ShiftReg : decompressor_kernel_fifo_w16_d2_S_ShiftReg
    generic map (
...
entity decompressor_kernel_fifo_w16_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 16;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end decompressor_kernel_fifo_w16_d2_S_ShiftReg;

architecture rtl of decompressor_kernel_fifo_w16_d2_S_ShiftReg is
