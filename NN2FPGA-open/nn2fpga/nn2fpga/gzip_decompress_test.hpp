...
//int main() {
  ...
  //  std::string compressedFileName = "gzipc_quant0_resnet8.bin";
  //  std::string originalFileName = "layer_0_quantized_int8.bin";

  //  bool pass = validateFile(compressedFileName, originalFileName);
